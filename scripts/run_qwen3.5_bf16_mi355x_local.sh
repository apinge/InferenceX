#!/usr/bin/env bash
#
# Local runner for InferenceX benchmark: qwen3.5_bf16_mi355x.sh
# Runs the single-node Qwen3.5-397B-A17B BF16 SGLang benchmark without GitHub Actions.
#
# Usage:
#   ./scripts/run_qwen3.5_bf16_mi355x_local.sh [CONC] [ISL] [OSL]
#
# Examples:
#   ./scripts/run_qwen3.5_bf16_mi355x_local.sh              # defaults: CONC=4, 1k1k
#   ./scripts/run_qwen3.5_bf16_mi355x_local.sh 8            # CONC=8, 1k1k
#   ./scripts/run_qwen3.5_bf16_mi355x_local.sh 16 1024 8192 # CONC=16, 1k8k
#
...
#   MODEL                 - HuggingFace model (default: Qwen/Qwen3.5-397B-A17B)
...
# --- Parameters (from .github/configs/amd-master.yaml qwen3.5-bf16-mi355x-sglang)
...
export RESULT_FILENAME="${EXP_NAME}_bf16_sglang_tp${TP}-ep1-dpaFalse_disagg-false_spec-none_conc${CONC}_local"
...
BENCH_SCRIPT="$REPO_ROOT/benchmarks/single_node/qwen3.5_bf16_mi355x.sh"
