#!/usr/bin/env bash
#
# Local runner for InferenceX benchmark: qwen3.5_fp8_mi355x.sh
...
#
# Examples:
#   ./scripts/run_qwen3.5_fp8_mi355x_local.sh              # defaults: CONC=4, 1k1k
#   ./scripts/run_qwen3.5_fp8_mi355x_local.sh 8            # CONC=8, 1k1k
#   ./scripts/run_qwen3.5_fp8_mi355x_local.sh 16 1024 8192 # CONC=16, 1k8k
#
...
# --- Parameters (from .github/configs/amd-master.yaml qwen3.5-fp8-mi355x-sglang)
...
BENCH_SCRIPT="$REPO_ROOT/benchmarks/single_node/qwen3.5_fp8_mi355x.sh"
